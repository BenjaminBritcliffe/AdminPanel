...
*/
 ...
 function renderForm($id, $name,$website,$active,$error)
 {
 ?>
...
<strong>Availability: * <select name="active">
...
<p>* required</p>
 ...
 //error, display form
 renderForm($id, $name,$website,$active,$error);
 }
 else
 {
 // save the data to the database
 mysql_query("UPDATE suppliers SET name='$name', website ='$website', active ='$active' WHERE id='$id'")
 or die(mysql_error()); 
 
 // once saved, redirect back to the view page
 header("Location:editsuppliers.php"); 
 }
 }
 else
 {
 ...
 // query db
 $id = $_GET['id'];
 $result = mysql_query("SELECT * FROM suppliers WHERE id='$id'")
 or die(mysql_error()); 
...
$active = $row['active'];
 ...
 // show form
 renderForm($id, $name, $website,$active, '');
 }
 else
